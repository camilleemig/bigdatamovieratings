...
class PrepData:
    ...
    def read_ratings(self):
        ...
        for line in ratings_file:
            ...
            # store the rating of the movie for the user's genre movie_ratings
        ...
        # convert user genre movie_ratings to one average instead a list of movie_ratings
    ...
    def prep_data(self):
        self.read_movies()
        self.read_ratings()     # read movie_ratings depends on read movies
